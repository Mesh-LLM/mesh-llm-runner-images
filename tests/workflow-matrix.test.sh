...
grep -Fq 'allows public repositories' "$operations_audit"
grep -Fq 'all workflows' "$operations_audit"
grep -Fq 'blocked pending a' "$operations_audit"
grep -Fq 'dedicated runner-group reconfiguration and verification' "$operations_audit"
...
grep -Fq 'configure and confirm a dedicated Depot runner group' "$operations_audit"
